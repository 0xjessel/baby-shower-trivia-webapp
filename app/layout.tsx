  ...
  return (
    <html lang="en" className="bg-arcane-navy text-arcane-gray-light">
      <head>
        ...
        <meta name="description" content="A fun League of Legends themed trivia game for 1st birthdays" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="Baby Jayce's League Challenge" />
        <meta property="og:description" content="A fun League of Legends themed trivia game for 1st birthdays" />
