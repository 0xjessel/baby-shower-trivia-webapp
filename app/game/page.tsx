...
export default function GamePage() {
    ...
    gameChannel.bind(
      ...
      (data: {
        ...
        if (currentQuestionRef.current && data.questionId === currentQuestionRef.current) {
          ...
          console.log("[DEBUG] Custom answer already exists:", exists)

          if (!exists) {
            console.log("[DEBUG] Adding new custom answer to state")
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-arcane-navy p-4 pt-16 md:pt-4">
      ...
      {/* Player name display */}
      {playerName && <div className="text-arcane-gold font-medium text-center mb-3 w-full max-w-md">{playerName}</div>}
        ...
        <CardContent className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              ...
              {/* Custom answer input - NOT inside a form */}
